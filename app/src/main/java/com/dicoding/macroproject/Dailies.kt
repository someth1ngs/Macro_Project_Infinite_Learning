 ...
 * Use the [Dailies.newInstance] factory method to
...
class Dailies : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_dailies, container, false)
        ...
        fragmentTask.visibility = View.VISIBLE
    ...
    companion object {
         ...
         * @return A new instance of fragment Dailies.
         */
